...
class TestBaseModel(unittest.TestCase):
    ...
    def test_save(self):
        ...
        self.assertEqual(my_model_json['name'], "First Model")
    ...
    def test_init_with_kwargs(self):
        ...
        kwargs = {
            'id': '12345hfhdk678',
            'created_at': '2023-12-12T11:36:00.000000',
            'name': 'John Doe',
            'value': 89
        }
        ...
        self.assertEqual(base_mode.created_at, datetime(2023, 12, 12, 11, 36))
        self.assertEqual(base_mode.name, 'John Doe')
